...
namespace caribou::topology {
    ...
    public:
        ...
        [[nodiscard]] auto number_of_nodes_per_elements() const -> INTEGER_TYPE final {
            return Element::NumberOfNodesAtCompileTime;
        }
        ...
        [[nodiscard]] auto number_of_nodes_of_element(const UNSIGNED_INTEGER_TYPE & element_id) const -> UNSIGNED_INTEGER_TYPE final {
            ...
            if constexpr (Element::NumberOfNodesAtCompileTime == caribou::Dynamic) {
                ...
                return static_cast<UNSIGNED_INTEGER_TYPE>(Element::NumberOfNodesAtCompileTime);
            }
        }
        ...
        void add_element(const UNSIGNED_INTEGER_TYPE * node_indices, UNSIGNED_INTEGER_TYPE number_of_nodes) final {
            if (Element::NumberOfNodesAtCompileTime != caribou::Dynamic and Element::NumberOfNodesAtCompileTime != number_of_nodes) {
                throw std::runtime_error(
                    "Trying to add an element of " + std::to_string(Element::NumberOfNodesAtCompileTime) + " nodes with an array containing " + std::to_string(number_of_nodes) + " node indices.");
